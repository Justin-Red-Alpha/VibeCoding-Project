#!/usr/bin/env bash
#
# VENDORED from the supercharge skill (~/.claude/skills/supercharge/scripts/
# drift-check.sh) so CI doesn't depend on ~/.claude. Keep the two identical:
# edit upstream, then copy it here with this header. Last synced 2026-09-25.
